...
| Trần Minh Hạnh | Tính `error_rate_pct`; tổng hợp 6 nhóm metrics từ JSONL; dashboard 60 phút, refresh 30 giây, threshold và time series theo phút; unit/integration tests | [fbac78f](https://github.com/AnhDc2004/DAY13-K4-2A202601714-G36/commit/fbac78f)| Phân biệt request attempt với success/error; tính percentile, error rate và bucket metrics theo thời gian |
